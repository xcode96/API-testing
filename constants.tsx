...
export const INITIAL_MODULE_CATEGORIES: ModuleCategory[] = [
    ...
    },
    {
        ...
        title: 'HR Exam',
        modules: [
            { id: 'hr_recruitment_onboarding', title: 'Recruitment & Onboarding', questions: 2, icon: ICONS.Briefcase, status: ModuleStatus.NotStarted, theme: THEMES[11] },
            { id: 'hr_attendance_leave', title: 'Attendance & Leave Policy', questions: 2, icon: ICONS.Clock, status: ModuleStatus.NotStarted, theme: THEMES[8] },
            { id: 'hr_workplace_conduct', title: 'Workplace Conduct & Ethics', questions: 2, icon: ICONS.Scale, status: ModuleStatus.NotStarted, theme: THEMES[14] },
            { id: 'hr_benefits_payroll', title: 'Employee Benefits & Payroll', questions: 2, icon: ICONS.DocumentText, status: ModuleStatus.NotStarted, theme: THEMES[12] },
            { id: 'hr_performance_appraisal', title: 'Performance & Appraisal', questions: 2, icon: ICONS.ChartBar, status: ModuleStatus.NotStarted, theme: THEMES[15] },
            { id: 'hr_grievance_resolution', title: 'Grievance & Conflict Resolution', questions: 2, icon: ICONS.Warning, status: ModuleStatus.NotStarted, theme: THEMES[5] },
            { id: 'hr_exit_clearance', title: 'Exit & Clearance Policy', questions: 2, icon: ICONS.Lock, status: ModuleStatus.NotStarted, theme: THEMES[4] },
        ]
    },
    {
        id: 'it_policy_exam',
    ...
    },
    {
        ...
        title: 'Server Policy',
        modules: [
             { id: 'server_exam', title: 'Server Exam', questions: 1, icon: ICONS.Server, status: ModuleStatus.NotStarted, theme: THEMES[12] },
        ]
    },
    {
        id: 'operation_exam',
    ...
    },
    {
        ...
        title: 'Legal Policy',
        modules: [
             { id: 'legal_exam', title: 'Legal Exam', questions: 10, icon: ICONS.Scale, status: ModuleStatus.NotStarted, theme: THEMES[14] },
        ]
    },
    {
